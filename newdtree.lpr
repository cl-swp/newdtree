...
(define-project :name :newdtree
  :modules (list (make-instance 'module :name "../utilities/utilities.lisp")
                 (make-instance 'module :name "newdtree.lisp"))
  :projects (list (make-instance 'project-module :name "../iri/iri" :show-modules nil))
  :libraries nil
  :editable-files nil
